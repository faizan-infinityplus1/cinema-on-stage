...
Route::get('/book-now.php/dallas.php', [MainController::class, 'dallas'])->name('dallas');
Route::get('/book-now.php/san-jose.php', [MainController::class, 'sanjose'])->name('san.jose');
Route::get('/book-now.php/los-angeles.php', [MainController::class, 'losangeles'])->name('los.angeles');

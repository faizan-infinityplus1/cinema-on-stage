      ...
      <div class="row justify-content-center">
         <div class="col-xxl-10">
            <div class="fm-contact-content-wrapper ">
               <div class="row g-5">
                  <div class="col-md-12">
                     <h2 class="fade__anim-item ibm-plex title-anim1"
                        style="color: rgb(253, 101, 0); perspective: 400px;">
                        <div
                           style="display: block; text-align: center; position: relative; translate: none; rotate: none; scale: none; transform-origin: 705px 30px; transform: translate3d(0px, 0px, 0px); opacity: 1;">
                           Get In Touch</div>
                     </h2>
                  </div>
                     ...
                     <div class="fm-contact-info-wrapper">
                        ...
                        <div class="fm-contact-info-single mb-40">
                           ...
                           <div class="fm-contact-info-text">
                              ...
                              <p>
                                 <a href="mailto:info@cinemaonstage.com">
                                    <span class="__cf_email__"
                                       data-cfemail="cfa7aaa3a3a08fa9aea6a2aaa2aaaba6aee1aca0a2">info@cinemaonstage.com</span>
                                 </a>
                              </p>
                           </div>
                        </div>
